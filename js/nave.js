// nave
// position="74.66810061716642 1.3824830063646516 -11.254910537927953"


function nave1() {
    let navp = nave.getAttribute('position');
...
if (sumnav == 36) {
    console.log('bien');
    arraqwe1 = arraqwe1 + 50; 
    

arraqwe = arraqwe0 + " " + arraqwe1 + " " + arraqwe2;
let arraqwena1 = arraqwe1 -2.5;
let replaarraqwe = arraqwe.replace(/,/g,' ');
...
position1.value = arraqwe;
        ...
        navity.setAttributeNode(positionnavity1);
}
else{
    console.log('mal');
}
